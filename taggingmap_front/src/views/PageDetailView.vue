...
.filter-group label {
  display: block;
  margin-bottom: 4px; /* 레이블 아래 여백 축소 */
  font-weight: bold;
...
.modal-header h3 {
  margin: 0;
  color: #333;
  font-size: 16px; /* 폰트 크기 최적화 */
}

.close-button {
  background: none;
  border: none;
  font-size: 22px; /* 폰트 크기 축소 */
  cursor: pointer;
  color: #999;
  padding: 0; /* 패딩 제거 */
}
