  ...
  methods: {
    ...
    async handleEventNameChange() {
      try {
        ...
        // URL 목록 가져오기 - 루트 레벨 EVENTNAME 필드로 필터링
    ...
    async handleUrlChange() {
      try {
        ...
        // 선택된 URL의 TIME 목록 가져오기 - 루트 레벨 필드로 필터링
    ...
    resetFilters() {
      this.urls = [];
      this.times = [];
      this.selectedEventName = 'cts_view'; // 기본값을 노출(cts_view)로 설정
      this.selectedUrl = '';
      this.selectedTime = '';
      this.taggingMaps = [];
    },
